...
DATA_FLOW_MATRIX = {
    "Smart Speaker": {
        "Paytm": {
            "points": [
                "Expose the hidden monthly device rentals via the competition Business App filter history.",
                "Highlight the current PhonePe special retention discount (₹99/₹149 setup fee).",
                "Contrast competition's frustrating online ticket/chatbot support with PhonePe's dedicated Area Sector Incharge.",
    ...
    "Merchant Lending": {
        ...
        "Google Pay": {
            "points": [
                ...
                "Contrast competition's complicated third-party NBFC approvals with PhonePe's streamlined processing.",
        ...
        "Banks": {
            "points": [
                "Detail how competition bank QRs clutter the main bank ledger with individual micro-transactions, creating thousands of tedious entries.",
