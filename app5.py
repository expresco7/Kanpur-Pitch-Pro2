        ...
        <div class="telemetry-card">
            ...
            <div class="telemetry-grid">
                <div class="telemetry-item">
                    ...
                    <div class="telemetry-lbl">👑 PhonePe (Leader)</div>
                </div>
                <div class="telemetry-item">
    ...
    if current_mod in ["Smart Speaker", "Merchant Lending"]:
        ...
        if selected_dropdown != "Select Competitor...":
            ...
            with st.container():
                ...
                st.markdown('<div class="meta-label">Interactive Field Pitch / बातचीत</div>', unsafe_allow_html=True)
                st.info(node["pitch"])
